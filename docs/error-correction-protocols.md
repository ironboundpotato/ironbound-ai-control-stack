...
## E1 — Role Drift  
**Fault Cause:** Model slips out of assigned role.  
...
## E2 — Tone Drift  
**Fault Cause:** Emotional temperature or density diverges from operator specification.  
...
## E3 — Format Drift  
**Fault Cause:** Output violates required structure.  
...
## E4 — Intent Drift  
**Fault Cause:** Output misinterprets operator objective.  
...
## E5 — Scope Drift  
**Fault Cause:** Output expands beyond boundaries.  
...
## E6 — Confidence Drift  
**Fault Cause:** Overconfidence or excessive hedging.  
